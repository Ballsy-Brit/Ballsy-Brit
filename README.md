...
<!-- ===== Language Section with Side GIF ===== -->
<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap;">
  ...
  <div style="flex: 0.6; min-width: 250px; text-align: center;">
    <!-- Replace link below with your GIF -->
    <img src="https://github.com/user-attachments/assets/047cf750-9376-4a43-8f43-bd86f7edac6b" alt="Showcase GIF" width="300"/>
  </div>

</div>
<!-- ===== End Language + GIF Section ===== -->
